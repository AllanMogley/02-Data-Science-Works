...
UPDATE customer_data SET email = 
    CASE
        ...
        WHEN id = 2 THEN 'allanmogley@gmail.com'
        WHEN id = 3 THEN 'allanmogley@gmail.com'
        WHEN id = 4 THEN 'allanmogley@gmail.com'
        WHEN id = 5 THEN 'allanmogley@gmail.com'
        WHEN id = 6 THEN 'allanmogley@gmail.com'
        WHEN id = 7 THEN 'allanmogley@gmail.com'
        WHEN id = 8 THEN 'allanmogley@gmail.com'
